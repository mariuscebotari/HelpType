...
const Preloader = (function() {
  ...
  const progress = preloader ? preloader.querySelector('.preloader__progress') : null;
  const progressInner = preloader ? preloader.querySelector('.preloader__progress__inner') : null;

  function initial() {
      if (!preloader || !bg || !progress || !progressInner) return;
